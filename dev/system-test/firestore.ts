...
import {CollectionReference, DocumentChange, DocumentData, DocumentSnapshot, FieldPath, FieldValue, Firestore, GeoPoint, Query, QueryDocumentSnapshot, QuerySnapshot, setLogFunction, Timestamp} from '../src';
...
describe('Query class', () => {
  ...
  const paginateResults =
      (query: Query, startAfter?: unknown): Promise<ResultPage> => {
